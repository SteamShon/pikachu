...
function MemberTable({
  ...
  const allCampaigns = serviceTree
    ? Object.values(serviceTree.placementGroups).flatMap((placementGroup) => {
        return Object.values(placementGroup.placements).flatMap((placement) => {
          return Object.values(placement.campaigns);
        });
      })
    : [];
  ...
  const rows = campaigns.flatMap((campaign) => {
    return Object.values(campaign.adGroups).map((adGroup) => {
