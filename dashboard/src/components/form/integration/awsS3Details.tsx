...
function AWSS3Details({ prefix }: { prefix?: string }) {
  const fieldPrefix = prefix || "details";
        ...
        <div className="mx-auto mt-8 mb-0 max-w-md space-y-4">
          ...
          >
            <input
              ...
              className="peer h-8 w-full border-none bg-transparent p-0 placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm"
              {...register(`${fieldPrefix}.s3AccessKeyId`)}
            />
          ...
          >
            <input
              ...
              className="peer h-8 w-full border-none bg-transparent p-0 placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm"
              {...register(`${fieldPrefix}.s3SecretAccessKey`)}
            />
          ...
          >
            <input
              ...
              className="peer h-8 w-full border-none bg-transparent p-0 placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm"
              {...register(`${fieldPrefix}.s3Buckets`)}
            />
